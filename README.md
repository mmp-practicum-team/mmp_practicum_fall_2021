...
Курс читается в поддержку курса "Математические методы распознавания образов" (машинное обучение, часть 1), читаемого на кафедре ММП. В ходе курса студенты выполняют различные практические задания.
...
## Предварительный формат сдачи курса
...
4. Предварительные критерии итоговой оценки:
   * **отлично $\geq$ 185 баллов**, 3 практических задания зачтены
   * **хорошо $\geq$ 139 баллов**, 2 практических задания зачтены
   * **удовлетворительно $\geq$ 93 баллов**, 1 практическое задание зачтено
