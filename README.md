...
| 18 октября | 8 | <ul><li>Введение в обработку текстов</li></ul> | [Презентация](Seminars/Seminar%2008.%20Text%20processing/Обработка%20текстов%20в%20Python.pdf) | <ul><li>[Практическое задание 2: Градиентные методы обучения линейных моделей](Tasks/Task%2002/task_02.pdf)</li><li>Контест: [Градиентные методы обучения линейных моделей](https://contest.yandex.ru/contest/30312/enter/)</ul></li> |
...
| 22 ноября | 12 | <ul><li>Flask</li></ul> | [Простейшее Flask приложение](Seminars/Seminar%2012.%20Flask) | [Практическое задание 3: Ансамбли алгоритмов. Веб-сервер. Композиции алгоритмов для решения задачи регрессии](Tasks/Task%2003/task_03.pdf) |
